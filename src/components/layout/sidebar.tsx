...
const navigation = [
  {
    ...
    items: [
      ...
      { href: "/sales-evolution", label: "Évolution des ventes", icon: TrendingUp },
  ...
  const dynamicNavigation = navigation
    .map(group => {
      ...
      const filteredItems = group.items.filter(item => {
        ...
        // Restricted paths for Cashier
        const restrictedPaths = ["/", "/sales-evolution", "/margins", "/suppliers", "/orders"];
